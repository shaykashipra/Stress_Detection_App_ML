...
public class SoundLevelActivity extends AppCompatActivity {
    ...
    private void displaySoundLevel() {
        double currentDecibels = SoundLevelService.getCurrentDecibels();
        soundLevelTextView.setText(String.format(Locale.getDefault(), "Noise Level: %.2f dB", currentDecibels));
    }
}
